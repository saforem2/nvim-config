...
M.base_30 = {
  ...
  red = "#FF5252", -- StatusBar (username)
  baby_pink = "#E599F7",
  pink = "#FF67FF",
  line = "#33383d", -- for lines like vertsplit
  green = "#36CE5E", -- StatusBar (file percentage)
  vibrant_green = "#A9E34C",
  nord_blue = "#58a6ff", -- Mode indicator
  blue = "#1A8FFF",
  yellow = "#FFFF00",
  sun = "#D3FF00",
...
M.base_16 = {
  ...
  base08 = "#e599f7", -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  -- base08 = "#B392E9", -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  base09 = "#53DFDD", -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
  base0A = "#FF7575", -- Classes, Markup Bold, Search Text Background
  base0B = "#d3ff3b", -- Strings, Inherited Class, Markup Code, Diff Inserted
